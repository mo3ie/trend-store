...
function MoamalatPayContent() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg)] flex items-center justify-center" dir={rtl ? "rtl" : "ltr"}>
      <div className="text-center">
        <div className="w-10 h-10 border-2 border-purple-500 border-t-transparent rounded-full animate-spin mx-auto mb-4" />
        <p className="text-[var(--muted)] text-sm">{t("جارٍ تحميل بوابة الدفع...", "Loading payment gateway...")}</p>
      </div>
    </div>
  );
}
