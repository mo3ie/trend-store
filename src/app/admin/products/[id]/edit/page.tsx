    ...
    <div className="p-6 max-w-2xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-500 text-sm">عدّل بيانات المنتج وصوره وخياراته</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSave} className="space-y-5">
        ...
        <div className="bg-[#0f1320] border border-purple-500/20 rounded-2xl p-6 space-y-4">
          ...
          {variants.length === 0 && (
            <p className="text-gray-600 text-sm text-center py-3">لا توجد خيارات — أضف خيارات للمنتج (اختياري)</p>
          )}
        </div>
