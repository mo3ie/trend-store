          ...
          <div className="bg-[var(--surface)] border border-green-500/20 rounded-2xl p-5">
            ...
            {via && (
              <p className="text-[var(--muted-2)] text-xs mt-2">
                {t("طريقة الدفع:", "Payment method:")} {via === "cash" ? t("الدفع عند الاستلام", "Cash on delivery") : via === "dpay" ? t("بوابة DPay", "DPay gateway") : via === "moamalat" ? t("معاملات", "Moamalat") : via === "yusor" ? t("يسر باي", "Yusor Pay") : via === "masarafi" ? t("مصرفي باي", "Masarafi Pay") : via === "edfali" ? t("ادفع لي", "Edfali") : via === "mobicash" ? t("موبي كاش", "MobiCash") : via}
              </p>
            )}
          </div>
        )}
